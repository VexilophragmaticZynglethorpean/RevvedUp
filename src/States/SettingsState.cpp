...
void SettingsState::saveCurrentMap() {
    std::ofstream settingsFile(Util::getExecutablePath() / "settings.txt", std::ios::out | std::ios::trunc);
    if (settingsFile.is_open()) {
