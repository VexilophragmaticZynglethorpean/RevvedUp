...
std::string instructionsString = 
    ...
    std::string("4. Keep an eye on the timer located in the top right corner of the screen.\n") +
    std::string("5. You can switch maps from the settings menu for a new experience.") + 
